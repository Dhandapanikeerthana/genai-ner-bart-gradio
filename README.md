...
text = "My name is Keerthana , I'm building DeepLearningAI and I live in Chennai"
...
demo = gr.Interface(fn=ner,
                    ...
                    examples=["My name is Keerthana and I live in Chennai", "My name is Poli and work at HuggingFace"])
...
demo = gr.Interface(fn=ner,
                    ...
                    description="Find entities using the `dslim/bert-base-NER` model under the hood!",
                    allow_flagging="never",
                    examples=["My name is Keerthana, I'm building DeeplearningAI and I live in Chennai", "My name is Poli, I live in Vienna and work at HuggingFace"])
...
<img width="1306" height="697" alt="image" src="https://github.com/user-attachments/assets/ff4ac598-88c0-432e-940c-10d3e7764764" />

<img width="1350" height="704" alt="image" src="https://github.com/user-attachments/assets/c6645dab-80d8-41b9-8dac-e6df3d327103" />
